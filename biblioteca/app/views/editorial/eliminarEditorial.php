...
<body>
  ...
  <div class="row"> -->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo URLROOT; ?>Editorial/eliminarEditorial/<?php echo $data['nit']; ?>" method="post">
                    <div class="row">
                        <div class="col">
                            <input type="text" name="nit" class="form-control" value="<?php echo $data['nit']; ?>" placeholder="NIT" aria-label="nit">
                        </div>
                        <div class="col">
                            <input type="text" name="nombre" value="<?php echo $data['nombre']; ?>" class="form-control" placeholder="Nombre" aria-label="nombre">
                        </div>
                    </div><br>
                    <div class="row">
                        <div class="col">
