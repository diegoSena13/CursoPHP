...
class Libro extends Controller
{
    ...
    public function cargarLibro()
    {
       ...
       $fechaSalidad=$_POST["fechaSalidadLibro"];
    ...
    public function editarLibro()
    {
        ...
        $data = [
            ...
            'fechaSalida' => $libro->fechaSalidadLibro,
    ...
    public function editarLibro1()
    {
        $data=[
            ...
            'categoria' =>$_POST["categoria"],
            'editorial' =>$_POST["editorial"],
            'fechaSalida' => $_POST["fechaSalidadLibro"],
            'cantidad' => $_POST["cantidad"],
            'existencia' => $_POST["existencia"],
            'editorial_nit' => $_POST["editorial_nit"]
        ];

        $libro=$this->LibroModel->EditarLibro($data);
