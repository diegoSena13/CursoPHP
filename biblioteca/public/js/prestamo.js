...
let tblLibros = $("#tblLibros").DataTable({
  ...
  function agregarLibro(titulo, autor, categoria) {
    ...
    fila = `  
    <tr id='filas' > 
    <td><input type="text" name="idItem[]" id="idItem[]" value ='${titulo}' class="form-control form-control-sm" readonly></td>
    <td><input type="text" name="descripcion[]"  id="descripcion[]" value ='${autor}' class="form-control form-control-sm" readonly></td>
    <td><input type="text" name="cantidad[]"  id="cantidad[]" value ='${categoria}' class="form-control form-control-sm" readonly></td>
